...
/* interface data */
MdlrefDW_Controller_T Controller_MdlrefDW;

/* interface (pointer) data */
RT_MODEL_Controller_T * RTModel_ptr = &(Controller_MdlrefDW.rtm);
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  if (xilFcnId == 0) {
    ...
    Controller_initialize(rt_errorStatus, RTModel_ptr);
...
XIL_INTERFACE_ERROR_CODE xilSystemInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    Controller_Init(&(Controller_MdlrefDW.rtdw));
  } else {
    errorCode = XIL_INTERFACE_UNKNOWN_FCNID;
  }
   ...
   case XIL_PROCESS_PARAMS_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Controller_P.Q_max);
          xil_fcnid0_ws_params[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_ws_params[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Controller_P.Q_min);
          xil_fcnid0_ws_params[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_ws_params[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Ki_SIMC);
          xil_fcnid0_ws_params[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_ws_params[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Kp_SIMC);
          xil_fcnid0_ws_params[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_ws_params[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    /* Call all Set class methods */
    Controller(&(i_T_ref), &(i_T1), &(o_Q1), &(Controller_MdlrefDW.rtdw));
