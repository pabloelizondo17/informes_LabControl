...
#define S_FUNCTION_NAME                Controller_psf
...
static RegMdlInfo rtMdlInfo_Controller[1] = { "",
...
{
  {
    ...
    dims[0] = 1;
    dims[1] = 1;
    ssCheckSFcnParamValueAttribs(S, 0, "Q_max", DYNAMICALLY_TYPED, 2, dims, 0);
  }

  {
    ...
    dims[0] = 1;
    dims[1] = 1;
    ssCheckSFcnParamValueAttribs(S, 1, "Q_min", DYNAMICALLY_TYPED, 2, dims, 0);
  }

  {
    ...
    dims[0] = 1;
    dims[1] = 1;
    ssCheckSFcnParamValueAttribs(S, 2, "Ki_SIMC", DYNAMICALLY_TYPED, 2, dims, 0);
  }

  {
    ...
    dims[0] = 1;
    dims[1] = 1;
    ssCheckSFcnParamValueAttribs(S, 3, "Kp_SIMC", DYNAMICALLY_TYPED, 2, dims, 0);
  }
}
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, (char *)"Controller", rtMdlInfo_Controller, 1);
  }
...
static void mdlSetWorkWidths(SimStruct *S)
{
...

  {
    ...
    /* set datatype */
    dataTypeId = 1;
    ssRegDlgParamAsRunTimeParam(S, 0, 0, "P0_Q_max", dataTypeId);
    if (ssGetErrorStatus(S) != (NULL))
      return;
  }

  {
    ...
    /* set datatype */
    dataTypeId = 1;
    ssRegDlgParamAsRunTimeParam(S, 1, 1, "P1_Q_min", dataTypeId);
    if (ssGetErrorStatus(S) != (NULL))
      return;
  }

  {
    ...
    /* set datatype */
    dataTypeId = 1;
    ssRegDlgParamAsRunTimeParam(S, 2, 2, "P2_Ki_SIMC", dataTypeId);
    if (ssGetErrorStatus(S) != (NULL))
      return;
  }

  {
    ...
    /* set datatype */
    dataTypeId = 1;
    ssRegDlgParamAsRunTimeParam(S, 3, 3, "P3_Kp_SIMC", dataTypeId);
    if (ssGetErrorStatus(S) != (NULL))
      return;
  }
}
