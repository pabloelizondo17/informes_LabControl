###########################################################################
## Makefile generated for component 'Controller_implementacion'. 
## 
## Makefile     : Controller_implementacion.mk
## Generated on : Wed Sep 09 10:56:16 2026
## Final product: ./Controller_implementacion_rtwlib.a
...
PRODUCT_NAME              = Controller_implementacion
MAKEFILE                  = Controller_implementacion.mk
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Controller_implementacion_rtwlib.a
...
PRODUCT = ./Controller_implementacion_rtwlib.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/Controller_implementacion -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/leonardo -I$(ARDUINO_ROOT)/user/libraries/Servo/src -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arduinotarget/scheduler/include -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arduinobase/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=49911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=2 -DARDUINO_SERIAL_RECEIVE_BUFFER_SIZE=64 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -DMW_RTIO_SERIAL0 -DMW_NUM_PINS=30 -D_ONBOARD_EEPROM_SIZE_=1024
...
DEFINES_STANDARD = -DMODEL=Controller_implementacion -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/Controller_implementacion/Controller_implementacion.c
...
OBJS = Controller_implementacion.o
...
%.o : $(START_DIR)/slprj/ert/Controller_implementacion/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/Controller_implementacion/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Controller_implementacion/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller_implementacion.o : $(START_DIR)/slprj/ert/Controller_implementacion/Controller_implementacion.c
	$(CC) $(CFLAGS) -o "$@" "$<"
