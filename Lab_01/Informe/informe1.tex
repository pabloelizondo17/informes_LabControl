...
Estos resultados, permiten formar la función de transferencia resultante, con la forma de la ecuación \ref{eq:G_fopdt}, 
tal como se muestra a continuación.

\begin{equation}
        \begin{aligned}
                G{(s)} &= \frac{0.00495}{s + 0.00528} \cdot e^{-21.001 s} \\
        \end{aligned}
